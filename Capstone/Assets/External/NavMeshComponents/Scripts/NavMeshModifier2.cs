...
namespace NavMeshPlus.Components
{
    ...
    public class NavMeshModifier2 : MonoBehaviour
    {
        [SerializeField]
        bool m_OverrideArea;
        ...
        static readonly List<NavMeshModifier2> s_NavMeshModifiers = new List<NavMeshModifier2>();

        public static List<NavMeshModifier2> activeModifiers
        {
