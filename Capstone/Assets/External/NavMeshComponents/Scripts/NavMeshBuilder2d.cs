...
namespace NavMeshPlus.Extensions
{
    ...
    class NavMeshBuilder2d
    {
        ...
        {
            foreach (var modifier in root.GetComponentsInChildren<NavMeshModifier2>())
            {
        ...
        public static void CollectSources(List<NavMeshBuildSource> sources, NavMeshBuilder2dState builder, NavMeshModifier2 modifier, int area)
        {
        ...
        private static void AddDefaultWalkableTilemap(List<NavMeshBuildSource> sources, NavMeshBuilder2dState builder, NavMeshModifier2 modifier)
        {
            var tilemap = modifier.GetComponent<Tilemap>();
            if (tilemap != null)
            {
